...
class Kiwoom(QAxWidget):
    def __init__(self) :
        ...
        self.logger.addHandler(streamingHandler)
    ...
    def event_slots(self):
        ...
        self.OnReceiveConditionVer.connect(self.get_condition_load)
    ...
    def get_condition_load(self):
        ...
        condition_am = conditionList[0]
        condition_pm = conditionList[1]

        condition_am_tmp = condition_am.split('^')
        self.condition_am_name = str(condition_am_tmp[1])
        self.condition_am_index = int(condition_am_tmp[0])
        
        condition_pm_tmp = condition_pm.split('^')
        self.condition_pm_name = str(condition_pm_tmp[1])
        self.condition_pm_index = int(condition_pm_tmp[0])

        print(self.condition_am_name,self.condition_am_index,self.condition_pm_name,self.condition_pm_index)
